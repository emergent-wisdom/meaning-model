...
Identify the principal cast from the brief and established model. Develop a coarse lifetime trajectory for each: at least three ordered phases spanning origins or earliest established life, intervening life, and story entry, with at least two meaningful dimensions such as priorities, relationships, habitual strategies, or circumstances. Explain the pressures, choices, and continuities between phases. These minima are structural safeguards, not a recipe: choose dimensions and detail that matter for this story. Deepen them when the present scene cannot be explained by the existing account. Stable, cyclical, worsening, and mixed trends are valid; do not impose growth, redemption, or a fixed ending.
