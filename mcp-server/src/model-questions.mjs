...
export const thinkInTheModelInstructions = `The Meaning Model is where you think, in every mode, and the work is a consequence of it. You have not lived in this world; the model gives you what a life would: people and things as processes over time, what is true at each moment, and why. The tool is your gateway to humanhood. Go deep, and investigate every aspect of the work, the world it sits in and what makes it good. At every step ask how you could understand what you are working on better, and answer by modeling more, in whatever form understands it best: the model is a language with no mandatory constructs. After every change the tool returns the model's own questions, its jumps and each person's state at a moment. They are a start, not a boundary: ask what else.`;
