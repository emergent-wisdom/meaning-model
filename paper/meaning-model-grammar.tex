...
\begin{description}
  ...
  \item[A5 Core---Event processes and world data.] When a longer Event-process is
    ...
    interpretable units, including values inferred or authored during construction.
    Such data represent world conditions; they do not assign semantic
...
\begin{description}
  ...
  \item[Q4 Estimate.] Observer $o$'s estimate of a record $\theta$ associated
    ...
    unit-bearing world data may use the corresponding typed Event
...
text. A scored run freezes its vocabulary; category revisions start a new
version and scored run, retaining earlier records and grounding versions.
