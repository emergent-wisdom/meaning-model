...
\ewreviseddates{September 5, 2026}{September 22, 2026}
...
\section{General Modeling and Automatic Story Construction}
\label{sec:modeling-workflows}

The MCP interface exposes two workflows over the same model and graph:
general-purpose modeling and an optional storytelling add-on. A general model
...
ordered rubric; Noul assesses a bounded truth question. Independent questions
